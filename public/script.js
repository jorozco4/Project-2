...
formSubmitBtn.click((e) => {
    e.preventDefault()
    if ($("#brand").val() == "" || $("#name").val() == "" || $("#releaseYear").val() == "") {
...
function renderSneakers() {
    ...
    fetch(`https://v1-sneakers.p.rapidapi.com/v1/sneakers?limit=10&name=${userInfo.name}&releaseYear=${userInfo.relYear}&brand=${userInfo.brand}`, {
	"method": "GET",
	"headers": {
